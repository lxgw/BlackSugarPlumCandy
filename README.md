...
## 字体简介
「黑糖话梅」是一款基于多款开源字体融合而成的可爱风格字体，最初通过公众号「霞鹜」发布，应用于手机字体美化场景。目前该字体已正式在 GitHub 建立仓库，并依据 SIL Open Font License 1.1 协议开源发布。
...
- 本字体在制作过程中移除了 OpenType 特性，部分高级排版功能（如竖排特性等）无法使用，敬请注意。
- 谚文（韩文）部分：因 Jua 仅包含 2367 个常用谚文音节，剩余音节由思源黑体填充，故本字体所包含的谚文字形存在风格不统一的情况，使用韩文时可能出现视觉不一致的问题。
